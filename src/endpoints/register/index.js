...
exports.handler = async (event) => {
    ...
    switch (event.requestContext.http.method) {
        case 'POST':
            ...
            if(!(body.name && body.email && body.password && body.institution && body.city && body.workType && body.educationLevel)){
                return {
                    statusCode: 400,
                    body: JSON.stringify({
                        errorCode: 1,
            ...
            try{
                ...
                results = await conn.query({
                    ...
                    values: [body.name, body.email,password_hash, body.institution, body.city, body.workType, body.educationLevel],
                });

            }catch(e){

                if(e.message == 'duplicate key value violates unique constraint "users_pk"'){
                    return {
                        errorCode: 406,
                        errorMessge: 'O email ja esta cadastrado em outra conta'
                    }
                }
