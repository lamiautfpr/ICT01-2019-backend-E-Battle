...
exports.handler = async (event) => {
    ...
    switch (event.requestContext.http.method) {
        ...
        case 'PUT':
            ...
            if(!(body.name && body.institution && body.city && body.workType && body.educationLevel)){
                return {
                    statusCode: 400,
                    body: JSON.stringify({
                        errorCode: 1,
            ...
            results = await conn.query({
                ...
                values: [body.name, body.institution, body.city, body.workType, body.educationLevel, user],
            });
